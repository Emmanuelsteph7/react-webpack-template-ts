  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        type: 'asset/resource', // uses the asset resource module to handle them instead of imorting file-loader package
      },
      {
        test: /\.(woff(2)?|eot|ttf|otf|svg)$/, // searches for fonts and svgs
        type: 'asset/inline', // use asset inline module instead of url-loader
      },
    ],
  },
  output: {
